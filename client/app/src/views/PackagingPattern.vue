<template>
  <div>
      ...
      <div class="d-flex justify-content-center p-3">
        ...
        >
          <div class="text-center">
            <h3 class="mt-3 mb-4 borderBtm text-dark">
    ...
    <b-modal id="modal-1" title="Edit Package" @ok="editPackingData()">
      <form style="background-color: white" class="p-3 border rounded shadow">
        <div class="text-center">
          <h3 class="mt-3 mb-4 borderBttm text-dark">
            Create Packaging Pattern
          </h3>
        </div>
