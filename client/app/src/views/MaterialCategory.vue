  ...
  <div>
    ...
    <div class="d-flex flex-column align-items-center">
      <div id="posts" class="mt-5">
        <h3 class="text-primary borderBtm">Previously Added Materials</h3>
      </div>
    </div>
    <br />

    <!-- <input type="text" @input="search" placeholder="" /> -->
    <div class="input-group mb-3 container" id="searchBar">
      <input
        @input="search"
        type="text"
        class="form-control"
    ...
    <div class="container mt-5" id="addedMaterial" ref="table">
      <!-- {{ filteredTask }} -->
      <table class="table table-bordered">
        <thead class="designTable">
          <tr>
            <th>Sr No.</th>
            <th>Category</th>
            <th>Sub Category</th>
